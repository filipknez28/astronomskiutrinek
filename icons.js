...
(function (global) {
  const PATHS = {
    ...
    trash: '<path d="M8.4 8.2V6.8A1.4 1.4 0 0 1 9.8 5.4h4.4a1.4 1.4 0 0 1 1.4 1.4v1.4M6.5 8.2h11"/><path d="m9 8.2.5 10.1a1.3 1.3 0 0 0 1.3 1.2h2.4a1.3 1.3 0 0 0 1.3-1.2l.5-10.1"/><path d="M10.4 11.2v5M13.6 11.2v5"/>',
